...
function showlogin(from, byPwd){
	...
	jQuery("#loginwindow").load(url,function (data){
		...
		if (document.getElementById("username_new")) {
...
function checkchrom(){
	parent.location.href='http://www.zhaoxi.com';
}
function checkchrom_showhidden(){
	parent.location.href='http://www.zhaoxi.com?check=1';
...
function showLoginCodeTitle(){
	...
	jQuery.post("/app/my.zhaoxi.showCode4LoginFalse?um=" + encodeURIComponent(um) + "&t=" + new Date().getTime(), null, function(data){
