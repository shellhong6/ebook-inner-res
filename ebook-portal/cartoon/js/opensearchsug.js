			...
			createSugOptions: function(a, b, d, e) {
				return {
					...
					onconfirm: function(a, b, c, f, g) {
						...
						e && !g && e.submit(), jQuery("#searchForm .ico_btn_search").length > 0 && jQuery("#searchForm .ico_btn_search").click(), jQuery(".btn_search").length > 0 && jQuery(".btn_search").click(), jQuery("#searchBox .search-btn").length > 0 && jQuery("#searchBox .search-btn").click(), jQuery(".seach-wrap .search-btn").length > 0 && jQuery(".seach-wrap .search-btn").click(), jQuery(".search-box-new .search-btn").length > 0 && jQuery(".search-box-new .search-btn").click(), jQuery(".endSearchBar .search-btn").length > 0 && jQuery(".endSearchBar .search-btn").click(), jQuery(".rp-search-btn").length > 0 && jQuery(".rp-search-btn").click()
					},
					view: function(a) {
