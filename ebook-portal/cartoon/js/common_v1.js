...
function searchProduct(keyword){
	...
	if(keyword.length!=0){
		...
		if(!filter.test(keyword) || keyword=="在五亿文档库里搜索文档"){
			//alert("请输入正确的关键字");
		}else{
...
function searchNew(){
	...
	if(keyword=="" || keyword.length==0 || keyword=="在五亿文档库里搜索文档"){
		//alert("请输入要搜索的关键词!");
...
(function(window){
	...
	link_cartoon = new RegExp('manhua.docin.com'),//漫画
	link_daily = new RegExp('docin.com/daily/index.do'),//daily列表页
	link_kyzq = new RegExp('docin.com/kyzq/index.do'),//考研专区
	link_novel = new RegExp('docin.com/n-'),//小说
	link_report = new RegExp('baogao.docin.com');//报告
	link_pics = new RegExp('pic.docin.com');//图片频道
	...
	var connectOnline = '<div class="connectOnline"><a class="t" target="_blank" href="http:\/\/wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDAwNDI0MV80NzY5NjhfODAwMDA0MjQxXzJf" title="在线客服">在线客服</a></div>';
	/*微信推广*/
	...
	else if(link_docend.test(doc_url)||link_listindex.test(doc_url)||link_list.test(doc_url)||link_search.test(doc_url)||link_topic.test(doc_url)||link_doudanlist.test(doc_url)||link_doudan.test(doc_url)||link_topiclist.test(doc_url)||link_cartoon.test(doc_url)||link_kyzq.test(doc_url)||link_novel.test(doc_url)){
	...
	if(link_sendMessage.test(window.location.href)){
		...
		sideInner += '<div class="connectOnline"><a class="t" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2264972974&site=qq&menu=yes" title="客服咨询">客服咨询</a></div><div class="advice"><a class="t" href="'+ urlPrefix.www +'/newMessage/talksWithSys.do" target="_blank" title="意见反馈">意见反馈</a></div><div class="docinWX"><a class="t" href="javascript:;" title="微信推广">微信推广</a><div class="downloadMore"><p>添加微信关注，<span>惊喜好礼不定期派送中</span></p><dl class="clear"><dt><img class="DocinWxImg" src="" alt="豆丁网"></dt><dd>豆丁网</dd><dd class="txt5">微信号：doudingwang</dd><dd>扫左侧二维码关注“豆丁网”微信公众号，</dd><dd><span>随时随地即可享受多重好礼</span></dd></dl><span class="line clear"></span><p>更多豆丁微信号</p><div class="downloadList clear"><ul class=""><li><img class="docBuildImg" src="" alt="豆丁建筑"></li><li>豆丁建筑</li><li>微信号：doudingjz</li></ul><ul class=""><li><img class="docWordImg" src="" alt="豆丁文档"></li><li style="padding-left:15px;">豆丁文档<img class="docWordDyh" src="" style="vertical-align:middle;padding-left:10px;"></li><li>微信号：docin2013</li></ul><ul class=""><li><img class="docActiveImg" src="" alt="不止于书"></li><li>不止于书</li><li>微信号：buzhiyushu</li></ul></div></div></div></div>';
		...
		sideInner += '<div class="connectOnline"><a class="t" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2264972974&site=qq&menu=yes" title="客服咨询">客服咨询</a></div><div class="docinWX"><a class="t" href="javascript:;" title="微信推广">微信推广</a><div class="downloadMore"><p>添加微信关注，<span>惊喜好礼不定期派送中</span></p><dl class="clear"><dt><img class="DocinWxImg" src="" alt="豆丁网"></dt><dd>豆丁网</dd><dd class="txt5">微信号：doudingwang</dd><dd>扫左侧二维码关注“豆丁网”微信公众号，</dd><dd><span>随时随地即可享受多重好礼</span></dd></dl><span class="line clear"></span><p>更多豆丁微信号</p><div class="downloadList clear"><ul class=""><li><img class="docBuildImg" src="" alt="豆丁建筑"></li><li>豆丁建筑</li><li>微信号：doudingjz</li></ul><ul class=""><li><img class="docWordImg" src="" alt="豆丁文档"></li><li style="padding-left:15px;">豆丁文档<img class="docWordDyh" src="" style="vertical-align:middle;padding-left:10px;"></li><li>微信号：docin2013</li></ul><ul class=""><li><img class="docActiveImg" src="" alt="不止于书"></li><li>不止于书</li><li>微信号：buzhiyushu</li></ul></div></div></div><div class="advice"><a class="t" href="'+ urlPrefix.www +'/newMessage/talksWithSys.do" target="_blank" title="意见反馈">意见反馈</a></div></div>';
		var oSideBar = jQuery(sideInner).appendTo(document.body);
	}
	else{
...
function docinShare(n,event,from1,id){//n: 1-新浪微博2-QQ空间3-人人4-腾讯微博5-QQ好友6-微信 form: //1:专题  2：终极页  3：豆单  4：书房   5：商业工具  6:创业全案  7：微案例 8:素材终极页 9:会议
	...
	function shareAnylize(from1,id,snstype){
		jQuery.post('/jsp_cn/stat/shareStat.jsp',{'from':from1,'id':id,'snstype':snstype});
	}
...
jQuery(function(){
	...
	jQuery('.zhaoxippMode').remove();

	jQuery('.mh-nav').html('<a href="index.html" class="cur" title="首页" onmousedown="return inpmv(6165);">首页</a><span class="mh-sp"></span>');
	jQuery('.mh-nav-classic').remove();
	jQuery('.mh-top-head').remove();
