...
style.innerHTML = '.inertia{position: fixed;right: 10px;bottom: 50px;} .inertia a{display: inline-block;width: 60px;height: 60px;line-height: 1.16667;box-sizing: border-box;padding: 10px;background-color: #d67a38;color: #fff;border-radius: 99px;font-size: 16px;text-align: center;}';
document.head.appendChild(style);
var div = document.createElement('div');
div.setAttribute('class', 'inertia');
div.innerHTML = '<a target="_blank" href="../cartoon/index.html">去看漫画</a>';
